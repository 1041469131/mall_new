package com.zscat.mallplus.portal.util.applet;


import com.zscat.mallplus.portal.config.WxAppletProperties;
import com.zscat.mallplus.portal.util.CharUtil;
import com.zscat.mallplus.portal.util.MapUtils;
import com.zscat.mallplus.portal.util.SpringContextHolder;
import com.zscat.mallplus.portal.util.XmlUtil;
...
public class WechatUtil {
    ...
    public static WxAppletProperties wxAppletProperties = null;

    static {
        wxAppletProperties = SpringContextHolder.getBean(WxAppletProperties.class);
    }
    ...
    public static WechatRefundApiResult wxRefund(String outTradeNo, Double orderMoney, Double refundMoney) {
        ...
        //请求微信
        String reponseXml = sendSSLPostToWx(mapToXml, WechatConfig.getSslcsf(),wxAppletProperties.getRefundUrl());
     ...
     * @return
     */
   private static Map<Object, Object> buildRequsetMapParam(String outTradeNo, BigDecimal bdOrderMoney, BigDecimal bdRefundMoney) {
        Map<Object, Object> params = new HashMap<Object, Object>();
        //微信分配的公众账号ID（企业号corpid即为此appId）
        params.put("appid", wxAppletProperties.getAppId());
        //微信支付分配的商户号
        params.put("mch_id", wxAppletProperties.getMchId());
        //随机字符串，不长于32位。推荐随机数生成算法
        params.put("nonce_str", CharUtil.getRandomString(16));
        //商户侧传给微信的订单号
        params.put("out_trade_no", outTradeNo);
        //商户系统内部的退款单号，商户系统内部唯一，同一退款单号多次请求只退一笔
        params.put("out_refund_no", IdGeneratorUtil.getIdGeneratorUtil().nextId());
        //订单总金额，单位为分，只能为整数
        ...
        //操作员帐号, 默认为商户号
        params.put("op_user_id", wxAppletProperties.getMchId());
        //签名前必须要参数全部写在前面
        String sign = WechatUtil.arraySign(params, wxAppletProperties.getPaySignKey());
