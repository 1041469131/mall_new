...
/**
 * SpringSecurity的配置 https://github.com/shenzhuan/mallplus on 2018/4/26.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    httpSecurity.csrf()// 由于使用的是JWT，我们这里不需要csrf
      ...
      .permitAll()
      // 对登录注册要允许匿名访问
      .antMatchers("/api/applet/**", "/api/aliyun/oss/**", "/api/member/getPhoneNo", "/api/pay/notify","/api/pay/notify/refund",
        "/api/umsApplyMatcher/queryUmsApplyMatcher", "/api/umsApplyMatcher/saveOrUpdate", "/api/test/**", "/api/portal/**")
      .permitAll()
      //跨域请求会先进行一次options请求
