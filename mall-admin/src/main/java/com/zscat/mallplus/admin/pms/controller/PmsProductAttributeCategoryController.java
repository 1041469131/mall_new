...
public class PmsProductAttributeCategoryController {
    ...
    public Object getPmsProductAttributeCategoryByPage(PmsProductAttributeCategory entity,
        ...
        try {
            return new CommonResult().success(IPmsProductAttributeCategoryService.page(new Page<PmsProductAttributeCategory>(pageNum, pageSize), new QueryWrapper<>(entity).orderByDesc("id")));
        } catch (Exception e) {
    ...
    public Object savePmsProductAttributeCategory(PmsProductAttributeCategory entity) {
        try {
    ...
    public Object updatePmsProductAttributeCategory(PmsProductAttributeCategory entity) {
        try {
