...
import com.zscat.mallplus.admin.pms.service.IPmsProductCategoryService;
...
public class PmsProductCategoryController {
    ...
    public Object getList(@PathVariable Long parentId,
        ...
        return new CommonResult().success(IPmsProductCategoryService.page(new Page<PmsProductCategory>(pageNum, pageSize), new QueryWrapper<>(entity).orderByAsc("sort")));
    }
