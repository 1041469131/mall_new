...
public class PmsSkuStockController {
    ...
    public CommonResult<Page<PmsSkuStock>> getPmsSkuStockByPage(PmsSkuStock entity,
    ...
    @RequestMapping(value = "/select/{pid}", method = RequestMethod.GET)
    @ResponseBody
    ...
    /***************************新增接口*************************************/
    @SysLog(MODULE = "pms", REMARK = "根据商品id查询库存信息")
